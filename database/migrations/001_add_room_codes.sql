-- Migration: Add room code support to games table
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_games_public ON games(is_public) WHERE is_public = true;
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_games_active ON games(game_phase) WHERE game_phase != 'game_over';
