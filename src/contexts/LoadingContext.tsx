...
import type { PlayerClientState, TransitionState } from '@/lib/types';
import { Loader2 } from 'lucide-react';
import AvatarLoadingSequence from '@/components/game/AvatarLoadingSequence';

// Loading states now include TransitionState for type safety
export type LoadingState = 
  | 'idle'
  | 'initializing'
  | 'loading_game_data'
  | 'navigation'
  | TransitionState; // 'starting_game', 'transitioning'
